...
predictions_zarr_path = '../data/zarr/bruniss/scrolls/s1/fibers/new-fiber-preds/hz_regular'
...
shape_yx_transposed = False  # use for 2024-10-31 predictions at least
...
predictions_threshold = 0.5  # 200 for surfaces & older hz-fibres; 0.5 for new vt-fibres
